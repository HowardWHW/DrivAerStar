...
public class KwWakeRefine0521_yaw extends StarMacro {
  ...
  public double yawDeg = <<<yaw_deg>>>;
  public double yawRad = <<<yaw_rad>>>;
  public double[] yawReference = new double[] {<<<yaw_reference_x_m>>>, <<<yaw_reference_y_m>>>, <<<yaw_reference_z_m>>>};
  public double[] frontWheelOrigin = new double[] {<<<front_origin_x_m>>>, <<<front_origin_y_m>>>, <<<front_origin_z_m>>>};
  public double[] rearWheelOrigin = new double[] {<<<rear_origin_x_m>>>, <<<rear_origin_y_m>>>, <<<rear_origin_z_m>>>};
  public double[] yawedWheelAxis = new double[] {<<<axis_x>>>, <<<axis_y>>>, <<<axis_z>>>};
  ...
  private void executekxl() {
    // The custom external-aero setup omits the original porous engine-bay region.
  }
  ...
  private void executeExportCase(String dir) {
    ...
    importManager_0.setExportPath(dir+"KwWakeRefine0521_yaw.case");
    ...
    Boundary boundary_5 = 
      region_0.getBoundaryManager().getBoundary("body.part_01_Body.Surface");

    Boundary boundary_6 = 
      region_0.getBoundaryManager().getBoundary("body.part_02_UB_Smooth.Surface");
    ...
    importManager_0.setExportBoundaries(new NeoObjectVector(new Object[] {boundary_1, boundary_3, boundary_4, boundary_2, boundary_0, boundary_5, boundary_6, boundary_7, boundary_9, boundary_14, boundary_15}));
    ...
    importManager_0.export(resolvePath(dir+"KwWakeRefine0521_yaw.case"), new NeoObjectVector(new Object[] {region_0}), new NeoObjectVector(new Object[] {boundary_1, boundary_3, boundary_4, boundary_2, boundary_0, boundary_5, boundary_6, boundary_7, boundary_9, boundary_14, boundary_15}), new NeoObjectVector(new Object[] {}), new NeoObjectVector(new Object[] {}), new NeoObjectVector(new Object[] {primitiveFieldFunction_0, vectorMagnitudeFieldFunction_0, vectorComponentFieldFunction_0, vectorComponentFieldFunction_1, vectorComponentFieldFunction_2, vectorMagnitudeFieldFunction_1, vectorComponentFieldFunction_3, vectorComponentFieldFunction_4, vectorComponentFieldFunction_5, primitiveFieldFunction_1, primitiveFieldFunction_2}), NeoProperty.fromString("{\'exportFormatType\': 2, \'appendToFile\': false, \'solutionOnly\': false, \'dataAtVerts\': false}"));
  }
  ...
  private void execute_input(String dir) {
    ...
    partImportManager_0.importDbsParts(
        new StringVector(
            new String[] { resolvePath(dir + "Wheels_Front.dbs"),
  ...
  private void applyYawToImportedParts() {
    if (Math.abs(yawRad) < 1.0E-12) {
      return;
    }
    ...
    CartesianCoordinateSystem yawCoordinateSystem = labCoordinateSystem_0.getLocalCoordinateSystemManager()
        .createLocalCoordinateSystem(CartesianCoordinateSystem.class, "yaw_vehicle_reference");
    yawCoordinateSystem.getOrigin().setCoordinate(units_0, units_0, units_0, new DoubleVector(yawReference));
    yawCoordinateSystem.getXVector().setComponents(1.0, 0.0, 0.0);
    yawCoordinateSystem.getXyPlane().setComponents(0.0, 1.0, 0.0);

    MeshPart body = ((MeshPart) simulation_0.get(SimulationPartManager.class).getPart("body"));
    MeshPart wheelsFront = ((MeshPart) simulation_0.get(SimulationPartManager.class).getPart("Wheels_Front"));
    MeshPart wheelsRear = ((MeshPart) simulation_0.get(SimulationPartManager.class).getPart("Wheels_Rear"));

    simulation_0.get(SimulationPartManager.class).rotateParts(
        Arrays.asList(body, wheelsFront, wheelsRear),
        Arrays.asList(0.0, 0.0, 1.0),
        Arrays.asList(units_0, units_0, units_0),
        yawRad,
        yawCoordinateSystem);
  }
  ...
  private void execute0() {
    ...
    SubtractPartsOperation subtractPartsOperation_0 = (SubtractPartsOperation) simulation_0
        .get(MeshOperationManager.class).createSubtractPartsOperation(
            new NeoObjectVector(new Object[] { simpleBlockPart_0, meshPart_0, meshPart_2, meshPart_3 }));
    ...
    simulation_0.getRegionManager().newRegionsFromParts(
        new NeoObjectVector(new Object[] { meshOperationPart_0 }), "OneRegionPerPart", null,
    ...
    surfaceCustomMeshControl_0.getGeometryObjects().setObjects(geometryObjectProxy_0, geometryObjectProxy_2,
        geometryObjectProxy_3);
    ...
    cartesianCoordinateSystem_0.getOrigin().setCoordinate(units_0, units_0, units_0,
        new DoubleVector(frontWheelOrigin));
    ...
    cartesianCoordinateSystem_0.getOrigin().setValue(new DoubleVector(frontWheelOrigin));
    ...
    cartesianCoordinateSystem_1.getOrigin().setCoordinate(units_0, units_0, units_0,
        new DoubleVector(rearWheelOrigin));
    ...
    cartesianCoordinateSystem_1.getOrigin().setValue(new DoubleVector(rearWheelOrigin));
    ...
    localAxisLeaf_0.getAxisVector().setComponentsAndUnits(yawedWheelAxis[0], yawedWheelAxis[1], yawedWheelAxis[2], units_10);
    ...
    localAxisLeaf_01.getAxisVector().setComponentsAndUnits(yawedWheelAxis[0], yawedWheelAxis[1], yawedWheelAxis[2], units_10);
    ...
    localAxisLeaf_02.getAxisVector().setComponentsAndUnits(yawedWheelAxis[0], yawedWheelAxis[1], yawedWheelAxis[2], units_10);
  ...
  private void execute1(String dir) {
    ...
    scene_0.getCreatorGroup().setObjects(region_1);
    ...
    planeSection_0.getInputParts().setObjects(region_1);
    ...
    Boundary boundary_10 = region_1.getBoundaryManager().getBoundary("body.part_01_Body.Surface");

    Boundary boundary_14 = region_1.getBoundaryManager().getBoundary("body.part_02_UB_Smooth.Surface");
    ...
    forceReport_0.getParts().setObjects(boundary_2, boundary_10, boundary_14,
        boundary_15, boundary_18, boundary_6, boundary_8);
    ...
    simulation_0.saveState(dir + "star.KwWakeRefine0521_yaw.sim");
  }
  ...
  public void executeARF(String dir) {
    ...
    frontalAreaReport_1.getParts().setObjects(boundary_5, boundary_6, boundary_7, boundary_9, boundary_14, boundary_15);
  ...
  private void executeCD(String dir) {
    ...
    forceCoefficientReport_1.getParts().setObjects(boundary_0, boundary_1, boundary_2, boundary_4, boundary_9, boundary_10);
