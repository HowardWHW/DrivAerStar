...
stl_dir = r"D:\DrivAer\DrivAer_STLs\Notchback\body"
export_dir = r"D:\DrivAer\stl_N"
input_params = np.atleast_2d(
    np.loadtxt(os.path.join(script_dir, "lhs_parameters_Notch_v3.csv"), delimiter=",", skiprows=1)
)
...
# Goal-1 dry runs are driven only by the CSV rows.  Do not apply any
# sample deformation before the FFD loop.
