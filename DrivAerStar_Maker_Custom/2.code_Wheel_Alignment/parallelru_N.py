...
base_path = r"D:/DrivAer/DrivAer_STLs/"
back = "Notchback/"
file_path = base_path + back + "body/part_02_UB_Smooth.stl"
paras = os.path.normpath(os.path.join(script_dir, "../1.code_make_stls_by_blender/lhs_parameters_Notch_v3.csv"))
out_path = r"D:/DrivAer/stl_N/"
input_path = r"D:/DrivAer/stl_N/"
...
Wheels_Front = base_path + back + "body/part_05_Wheels_Front_Closed.stl"
...
Wheels_Rear = base_path + back + "body/part_06_Wheels_Rear_Closed.stl"
...
def process_item(i):
    ...
    try:
        if os.path.exists(input_path+rf"{id_str}/floor.txt"):
            ...
            return
        dwmesh = pv.read(input_path+rf"{id_str}/part_02_UB_Smooth.stl")
        fr, fl, rr, rl = sldw(dwmesh)
        ds, dr, dw = size_f[i], tires_diameter[i], tires_width[i]

        create_folder(id_str)
        
        wheels_front_path = base_path + back + "body/part_05_Wheels_Front_Closed.stl"
        ...
        output_front_path = input_path+rf"/{id_str}/part_05_Wheels_Front_Closed.stl"
        wheels_front.save(output_front_path)

        wheels_rear_path = base_path + back + "body/part_06_Wheels_Rear_Closed.stl"
        ...
        output_rear_path =input_path+ rf"/{id_str}/part_06_Wheels_Rear_Closed.stl"
...
if __name__ == "__main__":
    with multiprocessing.Pool(30) as pool:
        items = range(0, len(lhs_parameters))
